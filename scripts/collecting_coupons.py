...
Coupons in cereal boxes are numbered 1 to 5, and a set of one of each is required for a prize. With one coupon per box, how many boxes on average are required to make a compete set? From: Fifty Challenging Problems in Probability by Frederick Mosteller Problem 14
"""
